  ...
  return (
    <>
      ...
      <section className="mb-8">
        ...
        <p className="text-tx2 text-sm leading-relaxed">
          We use third-party AI services (including OpenAI, Kie.ai, and others) for video generation. Your product images may be processed by these services. We also use Google for authentication and AbacatePay for payment processing.
        </p>
      </section>
  ...
  return (
    <>
      ...
      <section className="mb-8">
        ...
        <p className="text-tx2 text-sm leading-relaxed">
          Utilizamos servi&ccedil;os de IA de terceiros (incluindo OpenAI, Kie.ai e outros) para gera&ccedil;&atilde;o de v&iacute;deos. Suas imagens de produtos podem ser processadas por esses servi&ccedil;os. Tamb&eacute;m usamos Google para autentica&ccedil;&atilde;o e AbacatePay para processamento de pagamentos.
        </p>
      </section>
