...
import { Zap, Star, Crown, Gauge, Calculator } from "lucide-react";
      ...
      <div className="max-w-5xl mx-auto px-6">
                    ...
                    <div className="flex items-center gap-2 mt-0.5">
                      {model.badge && (
                        <span
                          ...
                          style={{ background: model.accentBg, color: model.accent }}
                        >
                          {model.badge === "popular" ? <Star size={8} /> : <Crown size={8} />}
                          {model.badge === "popular"
        ...
        <RevealOnScroll delay={350}>
          <div className="flex justify-center mt-8">
            <Link
              href="/tools/simulate"
              className="inline-flex items-center gap-2 glass-card px-6 py-3 text-sm font-semibold text-tx hover:text-ac hover:border-ac/20 transition-all duration-200"
            >
              <Calculator size={16} />
              {t.sim_cta_button}
            </Link>
