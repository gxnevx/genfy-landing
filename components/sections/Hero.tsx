    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20">
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-6 text-center">
        ...
        >
          ...
          <a href="#platform" className="btn-ghost px-5 py-2.5 text-sm">{t.hero_cta2}</a>
        </div>
        ...
        {/* Watermark logo */}
        <div className="mt-16 flex justify-center animate-fade-in" style={{ animationDelay: "700ms", animationFillMode: "both" }}>
          <div className="relative">
            <GenfyLogo size={72} className="opacity-[0.12]" />
            <div className="absolute inset-0 blur-[40px] opacity-20" style={{ background: "radial-gradient(circle, rgba(59,130,246,0.3), transparent)" }} />
          </div>
        </div>
      </div>
    </section>
