  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20">
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-6 text-center">
        ...
        >
          <a href={APP_URL} target="_blank" rel="noopener noreferrer" className="btn-accent px-6 py-3 text-sm gap-2" onClick={() => trackHeroCta("start_creating_free")}>
            {t.hero_cta}
            <ArrowRight size={15} />
          </a>
          <a href="#tools" className="btn-ghost px-5 py-2.5 text-sm" onClick={() => trackHeroCta("explore_tools")}>{t.hero_cta2}</a>
        </div>
