...
import { trackToolExplored } from "@/lib/analytics";
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
          {TOOLS.map((tool, i) => (
            <RevealOnScroll key={tool.nameKey} delay={i * 80}>
              <Link href={tool.href} className="block h-full" onClick={() => trackToolExplored(tool.href.replace("/tools/", "") as "trending-products" | "trending-sellers" | "product-validation")}>
